...
@WebServlet(name = "ServletDiretor", urlPatterns = {"/ServletDiretor"})
public class ServletDiretor extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        pessoa.setTitulacao(req.getParameter("titulacao"));
        ...
        switch (acao) {
            ...
            case "cad": {
                ...
                user.setMatricula(matricula.get(Calendar.YEAR) + "" + (matricula.get(Calendar.MONTH) + 1) + "" + user.getIdPessoa());
                user.setSenha("1234");
                user.setAtivo(true);
        ...
        redirecionamento.println("location='../projeto/DIRETOR/index.jsp';");
