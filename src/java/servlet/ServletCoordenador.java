...
@WebServlet(name = "ServletCoordenador", urlPatterns = {"/ServletCoordenador"})
public class ServletCoordenador extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        redirecionamento.println("location='../projeto/COORDENADOR/index.jsp';");
